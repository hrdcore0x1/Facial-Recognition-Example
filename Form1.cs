...
namespace FacialRecognition
{
    public partial class faceRecognition : Form
    {
        ...
        {
            Image<Gray, byte> train = grab.QueryGrayFrame().Resize(300, 250, Emgu.CV.CvEnum.INTER.CV_INTER_CUBIC);
            ...
            Image<Bgr, byte> current = grab.QueryFrame().Resize(300, 250, Emgu.CV.CvEnum.INTER.CV_INTER_CUBIC);
            train = current.Copy(detected[0][0].rect).Convert<Gray, byte>().Resize(100, 100, Emgu.CV.CvEnum.INTER.CV_INTER_CUBIC);
        ...
        private void btnLoad_Click(object sender, EventArgs e)
        {
            ...
            current = new Image<Bgr, byte>(file).Resize(300, 250, INTER.CV_INTER_CUBIC);
            picWebCam.Image = current.ToBitmap();
        }
